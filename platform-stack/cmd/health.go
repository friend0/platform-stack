...
func init() {
	...
	healthCmd.Flags().StringP("namespace", "", "", "Namespace")
	healthCmd.Flags().StringSliceP("label", "", []string{}, "Label selectors")
	healthCmd.Flags().StringSliceP("field", "", []string{}, "Field selectors")
}
